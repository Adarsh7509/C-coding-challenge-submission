using HospitalManagementSystem.BusinessLayer.Exceptions;
using HospitalManagementSystem.BusinessLayer.Services;
...
namespace HospitalManagementService
{
    public class MainModule
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("exi");  // final exit message
        }
    }
}
